...
\begin{itemize}
	\item \mintinline{bash}{git branch personal_photo} to create branch
	\item and then \mintinline{bash}{git checkout personal_photo} OR
	\item \mintinline{bash}{git checkout -b personal_photo} to do both in one line
\end{itemize}
\begin{center}
